...
<div class="wrap bh-wp-one-click-list-unsubscribe">
	...
	<p>The email account specified below will be checked on a schedule of <code><?php echo $fetch_emails_schedule; ?></code>. It was last checked <code><?php echo $last_checked; ?></code>. It will be next checked <code><?php echo $next_run; ?></code>. <a href="<?php echo $link_to_emails; ?>">View Emails</a>. <a href="<?php echo $link_to_logs; ?>">View Logs</a></p>
